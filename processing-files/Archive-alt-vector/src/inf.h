...
public:
    ...
    std::string linkOutfile;           // output file for the linked sites
    std::string doubleOutfile;         // output file for double counts
    ...
    int w;                  // window size for smoothing
    ...
    bool saveLinked;        // if true, output the linked sites
    bool saveDoubleCounts;  // if true, output double site counts
    ...
    std::string getLinkedOutfile()               { return (directory+"/"+linkOutfile);   }
    std::string getDoubleOutfile()               { return (directory+"/"+doubleOutfile); }
    ~RunParameters() {}
...
//void gaussianFrequencies(const IntVVector &sequences, const Vector &counts, int w, int t, int q, std::vector<double> &single_site, std::vector<double> &double_site);
//void findLinkedSites()
//void findLinkedPairs()
//void combineLinkedSites()
void findDoubleCounts(const IntVVector &sequences, const Vector &counts, int q, Vector &doubleCounts, double singleCounts[]);
