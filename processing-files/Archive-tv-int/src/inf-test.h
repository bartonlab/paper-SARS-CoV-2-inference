...
void processAsymptotic(const IntVVector &sequences, const Vector &counts, const Vector &muMatrix, int q, std::vector<double> &totalCov, double dx[]);
void processStandard(const IntVVector &sequences, const Vector &counts, const std::vector<double> &times, const Vector &muMatrix, int q, double dx[]);
