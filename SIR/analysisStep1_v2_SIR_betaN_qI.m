...
function analysisStep1_v2_SIR_betaN_qI(fileNameContainingDirPath, priorConst, FLAG_vector, varargin)
...
q_I_All = dlmread([dirNamePopN 'q_I.txt']);
if(runAnalysisCode)
...
%                     size(b_vec_allTP)
        ...
        %                 pause
                ...
                elseif(tp == numUniqueTimePoints)
                    ...
                    temp_deltaZ_vec = (q_I_sp' - temp_deltaX_vec_last);
