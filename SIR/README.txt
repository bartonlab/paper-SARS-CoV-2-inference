% README.TXT
% These codes were run on MATLAB R2017b and require Statistics and Machine Learning Toolbox' v11.2 and Bioinformatics Toolbox v4.9
%
...
% 2. This code is the frist preprocessing step. It prepares SIR time series
...
% 3. This code is the frist preprocessing step. It prepares SIR time series
