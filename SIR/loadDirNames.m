...
function [dirNameData, dirNameAnalysis, dirNameResults, dirNameABC, dirNameApproxWF] = loadDirNames(fileNameContainingDirPath)
...
for i = 1:numRows
    ...
    if(strcmp(temp(1), '%'))
        ...
        elseif(count == 3)
            dirNameResults = [dirNameData(1:length(dirNameData)-6) '/Results/'];
